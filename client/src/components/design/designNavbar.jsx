...
function DesignNavbar() {
  ...
  return (
    <>
      ...
      <nav
        className={
          "navbar h-[54px] z-10 top-0 sticky flex justify-between lg:px-[120px] py-3 border-b items-center bg-white tracking-[0.5px]" +
        ...
        <div className="flex items-center">
          ...
          {currentUser ? (
            <>
              ...
              <div
                className={
                  cart == 0 ? "popup-outer z-10" : "active popup-outer z-10"
                }
              >
                <div className="popup-box !max-w-[1024px]">
                  <i
                    id="close"
                ...
                {notifications == 1 && (
                  ...
                  >
                    ...
                    {feeds.map((feed) => (
                      <Link
                        to={feed.link}
                        className="block px-4 py-[9px] border-b w-[300px] flex transform transition duration-500 hover:scale-[1.01]"
                      >
                        <span
                          className={
                            feed.read == "1"
                              ? "text-gray-500 mr-[4px] text-[20px] -ml-[8px]"
                              : "text-blue-500 mr-[4px] text-[20px] -ml-[8px]"
                          }
                        >
                          #
                        </span>
