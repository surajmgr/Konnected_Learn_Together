...
var css = function css(props) {
  ...
  return "\n        .popup {\n min-width: 150px;\n         width: auto;\n          position: absolute;\n  background-color: #fff;\n         visibility: hidden;\n          z-index: 9999999999;\n          will-change: transform;\n          top: 0px;\n          left: 0px;\n          transform: translate3d(0px, 0px, 0px);\n          display:block;\n         border-radius: 6px;\n }\n        \n        .popupItem{width:auto; display: block; cursor:pointer;}\n        .popupItem:hover{ background-color: #f3f4f6;}\n        .popupItem:last-child{border-bottom:none}\n        .extracted-class {\n        position: relative;\n    display: inline-block;\n    }\n        .extracted-class::after {\n          background:  ".concat(color, ";\n          content: \"\";\n          display: block;\n          position: absolute;\n          z-index: 999;\n          left: 0;\n          right: 0;\n          opacity: 0.3;\n          top: 0;\n          bottom: 0;\n        }\n        \n        .extracted-simple-text {\n cursor: pointer;          background-color: ").concat(color, ";\n          color: black;\n        }\n        \n        .for-mobile {\n            position: fixed;\n            top: 50%;\n            right: 40px;\n            width: auto;\n        }\n        .visible {\n            visibility: visible;\n        }\n\n        #tooltip {\n background-color: #fff; --tw-shadow: 0 1px 3px 0 rgb(0 0 0 / 0.1), 0 1px 2px -1px rgb(0 0 0 / 0.1); --tw-shadow-colored: 0 1px 3px 0 var(--tw-shadow-color), 0 1px 2px -1px var(--tw-shadow-color); box-shadow: var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow); padding: 8px 12px;border-radius: 5px;font-size: 0.875rem;line-height: 1.25rem;color:#374151;            position: fixed;\n            display: none;\n        }\n     #tooltip:hover{ background-color: #f3f4f6;}\n         ");
};
    ...
    _defineProperty(_assertThisInitialized(_this), "parseItems", function (items) {
      if (items != null && items != undefined && items.length > 0) {
        ...
        items.forEach(function (item, index) {
          var handler = "<span class='popupItem p-[20px] border-b text-sm px-4 py-2 text-gray-700' data-action=\"".concat(index, "\"  id=\"").concat(item.text, "-").concat(index, "\">\n            ").concat(item.text, "\n          </span>");
          parsed += handler;
        });
        return parsed;
      }
  ...
  _createClass(PopOver, [{
    ...
    value: function componentDidMount() {
      ...
      if (this.checkMobile()) {
        ...
        span.innerHTML = "<span class='popup shadow border mt-[40px] py-2 list-none rounded-lg popup-button visible' id=\"popup-dynamic\" >\n              ".concat(parseItems, "\n            </span>");
        ...
        span.innerHTML = "<span class='popup shadow border mt-[40px] py-2 list-none rounded-lg popup-button' id=\"popup-dynamic\" >\n              ".concat(parseItems, "\n            </span>");
