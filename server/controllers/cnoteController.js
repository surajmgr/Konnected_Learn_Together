...
const addNote = (req, res) => {
    ...
    const q = `INSERT INTO notes (name,body,sst_name,subtopic,uid,date) VALUES ('${req.body.title.replaceAll("'", "''")}','${content}','${sst_name}',${req.body.subtopic},${userInfo.id},'${req.body.date}') RETURNING id;`
    console.log(q);
...
const deleteNote = (req, res) => {
    ...
    jwt.verify(token, "jwtkey", (err, userInfo) => {
        ...
        const q = `DELETE FROM Notes WHERE id = '${NoteId}' AND uid = '${userInfo.id}';`
        console.log(q);
        db.query(q, (err, data) => {
